...
public class ImagePreviewDelActivity extends ImagePreviewBaseActivity implements View.OnClickListener {
    ...
    private void showDeleteDialog() {
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                try {
                    deleteImageList.add(mImageItems.get(mCurrentPosition));
                    //移除当前图片刷新界面
                  mImageItems.remove(mImageItems.get(mCurrentPosition));
                    if (imageDeleteListener != null) {
                        imageDeleteListener.onImageDelete(mCurrentPosition);
                    }
    ...
    public void onBackPressed() {
        ...
        intent.putExtra(ImagePicker.DELETE_IMAGE_LIST, deleteImageList);
    ...
    public static OnImageDeleteListener imageDeleteListener; //图片删除的监听回调
